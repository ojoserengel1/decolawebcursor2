  ...
  return (
    <section className="relative bg-[#03041A] pt-28 pb-16 md:pt-48 md:pb-40 overflow-hidden flex flex-col items-center justify-center min-h-[90vh]">
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-20 text-center flex flex-col items-center">
        ...
        {/* Headline Principal */}
        <h1 className="text-[2rem] sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 md:mb-8 tracking-tight leading-[1.1] md:leading-[1.15]">
          <span className="md:hidden">Todos os dias as <br />pessoas buscam por <br />seu produto/serviço na <br />Internet. <span className="text-primary">Cadê seu site?</span></span>
          <span className="hidden md:inline">Todos os dias as pessoas buscam por seu produto/serviço na Internet. <br />
          <span className="text-primary">Cadê seu site?</span></span>
        </h1>
        
        {/* Subheadline */}
        <p className="text-base md:text-xl text-gray-400 mb-8 md:mb-12 font-light leading-relaxed max-w-[320px] md:max-w-[800px] mx-auto">
          Tenha um site profissional, domínio, hospedagem, e-mail, segurança, manutenção e suporte — tudo em um único plano por R$ 99,90/mês, feito para caber no bolso do empresário e sem se preocupar com a parte técnica.
        </p>
